...
A C++ implementation of a [feed-forward, fully-connected, multi-layer neural network](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.hpp) for single-output regression problems, including both [forward](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.cpp#L341) and [backward](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.cpp#L148) propagation, supporting [settable hyperparameters](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/main.cpp#L13) such as activation functions' kind (Leaky ReLU, ReLU or Sigmoid) and number of layers and number of neurons each, [trained](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.cpp#L432) via Stochastic Gradient Descent (mini-batches of 1 sample) and [evaluated](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.cpp#L279) in terms of Mean Squared Error respectively on [training](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/main.cpp#L30) and [validation](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/main.cpp#L35) partitions of a [self-made non-linear regression dataset](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/create_dataset.py): a 2D projection of a [Swiss Roll dataset by Scikit-Learn](https://scikit-learn.org/stable/modules/generated/sklearn.datasets.make_swiss_roll.html), whose samples are shown as color-coded by output value in the 2D feature space in the following picture.
...
After studying C++ syntax and reviewing neural networks' theory (mostly [gradient computation](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.cpp#L187) for backpropagation), I designed the [model class](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/model.hpp), made it computationally efficient, documented it (well-commented code) and added an example of [training](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/main.cpp#L59) and [evaluation](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/main.cpp#L66) on [such a self-made dataset](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/readme_pictures/separate_sets.png) (Python was used only for the [dataset creation](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/create_dataset.py) and for [displaying plots](https://github.com/MattiaSarti/neural-network-in-cpp/blob/main/plot_validation_predictions.py) because of its more suitable libraries, that came in handy), as an exercise to learn about C++ (and neural networks).
